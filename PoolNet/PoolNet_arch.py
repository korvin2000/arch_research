...
class PromptIR(nn.Module):
    def __init__(self, 
        ...
        if self.decoder:
            self.fre1 = AvgMax(dim*2**3)
            self.fre2 = AvgMax(dim*2**2)
            self.fre3 = AvgMax(dim*2**1)
    ...
    def forward(self, inp_img,noise_emb = None):
        ...
        if self.decoder:
            out_dec_level3 = self.fre2(out_dec_level3)
        ...
        if self.decoder:
            out_dec_level2 = self.fre3(out_dec_level2)
